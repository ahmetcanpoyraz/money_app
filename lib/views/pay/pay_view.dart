...
class PayView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<PayViewModel>(
      viewModel: Provider.of<PayViewModel>(context, listen: false),
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: CustomButton(
                            text: "next".tr(),
                            onPressed: viewModel.onNextButtonPress,
  ...
  Expanded numOfNumPad(
      BuildContext context, PayViewModel viewModel, String number) {
    return Expanded(
      child: NumPadButton(
        child: Text(
          number,
  ...
  Expanded doubtButtonOfNumpad(BuildContext context, PayViewModel viewModel) {
    return Expanded(
      child: NumPadButton(
        child: Text(
          ".",
  ...
  Expanded removeButtonOfNumPad(BuildContext context, PayViewModel viewModel) {
    return Expanded(
      child: NumPadButton(
        child: Icon(
